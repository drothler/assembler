...
void main()
{
    ...
    for(int i =0; i< arraysize1;i++){
        b1[i][0]= (int)(matrix1[i*3]);
         b1[i][1]= (int)(matrix1[i*3+1]);
          b1[i][2]=(int)( matrix1[i*3+2]);

    }

     for(int i =0; i< arraysize2;i++){
        b2[i][0]= (int)(matrix2[i*3]);
         b2[i][1]= (int)(matrix2[i*3+1]);
          b2[i][2]= (int)(matrix2[i*3+2]);
